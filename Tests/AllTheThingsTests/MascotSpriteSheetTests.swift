...
struct MascotSpriteSheetTests {
    ...
    func animationMetadataMatchesRuntimeStrips() {
        ...
        #expect(OperationMascotAnimation.searchRefining.resourceName == "NibOperationSearchRefiningStrip")
        #expect(OperationMascotAnimation.optimizing.resourceName == "NibOperationOptimizingStrip")
        #expect(OperationMascotAnimation.updating.resourceName == "NibOperationFileChangedStrip")
        ...
        #expect(OperationMascotAnimation.searchRefining.frameCount == 16)
        #expect(OperationMascotAnimation.optimizing.frameCount == 16)
        #expect(OperationMascotAnimation.updating.frameCount == 6)
        ...
        #expect(OperationMascotAnimation.searchRefining.framesPerSecond == 8)
        #expect(OperationMascotAnimation.optimizing.framesPerSecond == 5)
        #expect(OperationMascotAnimation.updating.framesPerSecond == 6)
        ...
        #expect(OperationMascotAnimation.indexing.playbackPriority > OperationMascotAnimation.updating.playbackPriority)
        #expect(OperationMascotAnimation.indexing.playbackPriority > OperationMascotAnimation.searchRefining.playbackPriority)
        ...
        #expect(OperationMascotAnimation.searchRefining.loops)
        #expect(OperationMascotAnimation.optimizing.loops)
        #expect(OperationMascotAnimation.updating.loops)
    ...
    func animationControllerKeepsIndexingAndOptimizingAheadOfLowerPriorityTransients() {
        ...
        #expect(controller.currentFrame == .animation(.indexing, index: 0))
        let didStartUpdating = controller.setPersistentAnimation(.updating)
        #expect(didStartUpdating)
        #expect(controller.currentFrame == .animation(.updating, index: 0))
