...
enum SnapshotLayout {
    ...
    static let obsoletePackageNames = [
        "filename-index-v7.attindex",
        "filename-index-v7-checkpoint.attindex",
    ...
    enum FileName {
        ...
        static let nameOrder = "nameOrder.bin"
        static let pathOrder = "pathOrder.bin"
        static let modifiedOrder = "modifiedOrder.bin"
        static let visibleModifiedOrder = "visibleModifiedOrder.i32"
        static let createdOrder = "createdOrder.bin"
        static let sizeOrder = "sizeOrder.bin"
        static let extensionOrder = "extensionOrder.bin"
        static let kindOrder = "kindOrder.bin"
        static let volumeOrder = "volumeOrder.bin"
    ...
    static func isObsoleteTemporaryName(_ name: String) -> Bool {
        (name.hasPrefix("filename-index-v7-") && name.hasSuffix(".attindex.tmp"))
